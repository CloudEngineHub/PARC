...
import parc.motion_tracker.learning.experience_buffer as experience_buffer
import parc.motion_tracker.learning.normalizer as normalizer
import parc.motion_tracker.learning.optimizer as optimizer
import parc.motion_tracker.learning.return_tracker as return_tracker
...
class BaseAgent(torch.nn.Module):
    ...
    def _build_optimizer(self, config):
        ...
        self._optimizer = optimizer.Optimizer(opt_config, params)
        return
    ...
    def _build_return_tracker(self):
        self._env._update_reward()
        reward_keys = list(self._env._info["rewards"].keys())
        self._train_return_tracker = return_tracker.ReturnTracker(self.get_num_envs(), self._device, reward_keys)
        self._test_return_tracker = return_tracker.ReturnTracker(self.get_num_envs(), self._device, reward_keys)
        return
    ...
    def _train_iter(self):
        ...
        info.update(self._train_return_tracker.get_all_mean_returns())
        return info
    ...
    def _rollout_test(self, num_episodes):
        ...
        if (num_episodes == 0):
            ...
            test_info.update(self._test_return_tracker.get_all_mean_returns())
        return test_info
